<?php
    ...
    define( 'K_SITE_URL', 'http://vital.bennyjake.com/' ); 
    ...
    define( 'K_DB_NAME', 'bennyjak_vital' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'bennyjak_quiet22' );
    // 6.
    // Database password 
    define( 'K_DB_PASSWORD', 'quietracket22' );
    // 7.
    // MySQL hostname (it will usually be 'localhost' )
    define( 'K_DB_HOST', '76.74.220.80:3306' );
    // 7b.
