...
<div style="clear:both;"><label style="float:left;width:230px !important;">Artwork Provided Via...</label><div style="width:85%;float:left;position:relative;margin-right: 12px !important;" ><select class="fox_dropdown foxtext" name="vital_email" style="width:100% !important;" onchange="DropdownAlignValue(this)" ><option value=""></option><option value="On-Line File Transfer">On-Line File Transfer</option><option value="On Disk">On Disk</option><option value="Hard Copy">Hard Copy</option><option value="Film Provided">Film Provided</option><option value="Please Estimate For Design">Please Estimate For Design</option></select><span class="outer_dropdown defaultfoxfield" ><span class="inner_dropdown" style="background-image:url(/media/com_foxcontact/images/dropdown-arrow-right.png);background-position:right 0;" id="ddi_18a1f52a60212ad1121be3c88fc52497" ></span></span></div>
&nbsp;</div>
